export const BLOG_POSTS = [
  {
    ...
    relatedServices: ['corte-laser-mdf', 'corte-laser-acrilico', 'corte-laser-maquetas'],
    content: [
      ...
      { type: 'cta', service: 'corte-laser-mdf', text: '¿Necesitás cortar MDF? Cotizalo ahora' },
  ...
  },
  {
    ...
    relatedServices: ['corte-laser-mdf', 'corte-laser-acrilico'],
    content: [
