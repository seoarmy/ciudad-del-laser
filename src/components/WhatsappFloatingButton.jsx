    ...
    <div className="fixed z-[999] bottom-[20px] md:bottom-[32px] right-[20px] md:right-[32px]">
      <div className="relative group flex items-center">
        ...
        <a
          ...
          className="wa-btn w-[56px] h-[56px] md:w-[64px] md:h-[64px] rounded-full bg-[#25D366] shadow-[0_8px_24px_rgba(37,211,102,0.4)] flex items-center justify-center text-white hover:scale-105 transition-transform"
        >
